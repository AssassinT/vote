            ...
            <div class="am-u-sm-12 am-u-md-6">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="user/create" type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                ...
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="am-hide-sm-only">{{$v['has_admin']}}</td>
                            <td class="am-hide-sm-only">{{$v['has_vip']}}</td>
                            <td class="am-hide-sm-only">{{$v['integral']}}</td>
                            <td class="am-hide-sm-only"><img src="{{$v['head_pic']}}" width="50"></td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
