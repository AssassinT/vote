      ...
      @if(Session::has('true'))
            <div class=" am-u-sm-12" style="padding:0px;margin:0px;">
                <div class="dashboard-stat green">
                        <div class="desc" style="text-align: center;line-height:45px;color:white">{{Session::get('true')}} </div>
                </div>
            </div>
            @endif
            ...
            <div class=" am-u-sm-12" style="padding:0px;margin:0px;">
                <div class="dashboard-stat red">
                        <div class="desc" style="text-align: center;line-height:45px;color:white">{{Session::get('false')}} </div>
                </div>
            </div>
            @endif
