                    ...
                    <tbody>
                       @foreach($order as $v)
                        <tr>
                            ...
                            <td id="ai" class="am-hide-sm-only">{{($v['statue'])==0 ? '支付中' : '已支付' }}</td>
                            <td class="am-hide-sm-only">{{$v['created_at']}}</td>
                            
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a href="" data_id="{{$v['id']}}"  class="am-btn am-btn-default am-btn-xs am-text-secondary" id="zhif"><span class="am-icon-pencil-square-o" ></span>{{($v['statue'])==0 ? '支付' : '已支付' }}</a>
