...
@section('content')
<p><b>一、总则</b><br>
1.1 xxx网的所有权和运营权归xxxxx有限公司所有。<br>
1.2 用户在允许刷礼物时，应当仔细阅读本协议，并同意遵守本协议后方可进行刷礼物功能。一旦同意，则用户与xxx网之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。<br>
1.3 本协议则可由xxx网随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分。<br>
<p><b>二、服务内容</b><br>
2.1 xxx网的具体内容由本站根据实际情况提供。 <br>
2.2 本站仅提供相关的网络服务，除此之外与相关网络服务有关的设备(如个人电脑、手机、及其他与接入互联网或移动网有关的装置)及所需的费用(如为接入互联网而支付的电话费及上网费、为使用移动网而支付的手机费)均应由用户自行负担。<br>
<p><b>三、关于刷礼物</b><br>
3.1 一旦允许刷礼物，可以获得本站规定用户所应享有的刷礼物功能。 <br>
3.2 用户创建投票同意刷礼物功能,<strong style="color:red;">用户将获得所创建的投票的中礼物所获得的80%的收益,20%归本平台所有</strong><br>
<p><b>四、使用规则</b><br>
...
4.3 用户承诺对其发表或者上传于本站的所有信息(<br>即属于《中华人民共和国著作权法》规定的作品，包括但不限于文字、图片、音乐、电影、表演和录音录像制品和电脑程序等)均享有完整的知识产权，或者已经得到相关权利人的合法授权；如用户违反本条规定造成本站被第三人索赔的，用户应全额补偿本站一切费用(包括但不限于各种赔偿费、诉讼代理费及为此支出的其它合理费用)； <br>
...
6.3 本站所有内容仅代表作者自己的立场和观点，与本站无关，由作者本人承担一切法律责任。 <br>
6.4 恶意转载本站内容的，本站保留将其诉诸法律的权利。<br>
<p><b>七、责任声明</b><br>
7.1 用户明确同意其使用本站网络服务所存在的风险及一切后果将完全由用户本人承担，xxx网对此不承担任何责任。 <br>
...
7.6 本站有权于任何时间暂时或永久修改或终止本服务(或其任何部分)<br>，而无论其通知与否，本站对用户和任何第三人均无需承担任何责任。<br>
<p><b>八、附则</b><br>
